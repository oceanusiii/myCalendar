...
public class Shift {
	...
	public Shift(String _id, String startTime, String endTime,
	...
	public Shift(String startTime, String endTime, String notification_Time,
			String name, String color_Text, String color_Pattern,
			String content, String notification) {
		super();
		this.startTime = startTime;
		this.endTime = endTime;
		this.notification_Time = notification_Time;
